<template>
    <section class="hero">
        ...
        // height: 30%;
      `"
            class="d-flex align-items-center position-relative aboutUs-top"
        >
            <div :class="`arrow-button left scroll-aboutUs ${scrollLeftDisabled ? 'disabled' : ''}`"
                 @click="scrollLeft">
                <div>
                    <i class="fas fa-angle-left"></i>
                </div>
            </div>
            <div class="overflow-auto ms-4 scrollbar-none icon-aboutUs">
                <div
                ...
                >
                    ...
                    >
                        <div class="item-achievement d-inline-block text-center">
                            <div class="text-p-white font-size-20 font-weight-700 font-year">
                                {{ item.year }}
                            </div>
                            <div class="text-p-white font-size-12 font-weight-400 font-description">
                                {{ item.description }}
                            </div>
                        </div>
                    </div>
            ...
            <div :class="`arrow-button right scroll-aboutUs ${scrollRightDisabled ? 'disabled' : ''}`"
                 @click="scrollRight">
                <div>
            ...
            <div class="row align-items-center gap-md-0 gap-3">
                ...
                <div class="col-md-8">
                    <div class="font-size-16 font-weight-400" style="text-align:justify; direction:ltr;">
                        Today, to emphasize its existence as a trading company in the market and within the Salim Group,
                        PT Elevenia Sinergi Prima Nusantara (ESPN) manages the elevenia.biz and e-Nusantara businesses.
                        It was moving away from its predecessor company and present to actively develop potential
                        Indonesian commodities and embrace every business opportunity from any parties with similar
                        objectives to collaborate in expanding access to the local and global market. At the same time,
                        ESPN also maintained its role in providing solution-based services to support the corporation’s
                        business performance, that’s satisfying and beneficial for the stakeholders
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center gap-md-0 gap-3">
                ...
                <div class="col-md-8">
                    <div class="font-size-16 font-weight-400" style="text-align:justify;, direction=ltr;">
                        ...
                        the missions began with empowering the farmers to harvest the most
